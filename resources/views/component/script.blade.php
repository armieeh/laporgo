...
<script>
  function previewImages(event) {
    ...
    preview.innerHTML = ''; // menghapus tampilan preview sebelumnya
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      reader.onload = function() {
        ...
        img.src = reader.result; // menampilkan gambar terpilih
  
        preview.appendChild(img); // menambahkan gambar ke dalam tampilan preview
      }
  
      reader.readAsDataURL(files[i]); // membaca gambar sebagai URL data
    }
  }
</script>