        ...
        <div class="container py-5 py-sm-7">
            ...
            <div class="mx-auto" style="max-width: 30rem;">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                        <form class="js-validate needs-validation" novalidate action="{{ route('admin.login') }}"
                            method="post">
                            @csrf
                            <div class="text-center">
                                <div class="mb-5">
                                    <h3 class="display-5">Form Login Admin</h3>
                                </div>
                            </div>
                            <!-- Form -->
                            <div class="mb-4">
                                ...
                                <input type="text" name="username" class="form-control form-control-lg"
                                    id="signinSrEmail" tabindex="1" placeholder="username" aria-label="username"
                                    autofocus required>
