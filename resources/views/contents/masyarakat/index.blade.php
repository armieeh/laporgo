    ...
    <div class="container-lg content-space-t-3 content-space-t-lg-4 content-space-b-2">
        <div class="w-lg-75 text-center mx-lg-auto text-center mx-auto">
            ...
            <div class="mb-7 animated fadeInUp">
                <h1 class="display-2">Layanan Aspirasi dan Pengaduan <span class="text-primary text-highlight-warning">Online</span> Rakyat
                <p class="fs-2 mt-3">Sampaikan laporan Anda langsung kepada instansi pemerintah berwenang</p>
            </div>
            <!-- End Heading -->
        </div>
    </div>
                    ...
                    <form action="{{ route('pekat.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="input-group input-group-merge input-group-light">
                                <textarea name="isi_laporan" id="exampleFormControlTextarea1" class="form-control" placeholder="Masukkan Isi Laporan*" rows="4" value="{{ old('isi_laporan') }}"></textarea>
                            </div>
                        </div>

                        <div class="mb-3">
                            <div class="input-group input-group-merge input-group-light">
                                <input name="tgl_pengaduan" type="date" id="exampleFormControlTextarea1" class="form-control" placeholder="Tanggal Kejadian" rows="4" value="{{ old('tgl_pengaduan') }}">
                            </div>
                        </div>

                        <div class="mb-3">
                            <div class="input-group input-group-merge input-group-light">
                                <input name="lokasi" type="text" id="exampleFormControlTextarea1" class="form-control" placeholder="Ketik Lokasi Kejadian" rows="4" value="{{ old('lokasi') }}">
                            </div>
                        </div>
                        
                        <div class="mb-3">
                            <label class="form-check form-check-dashed" for="logoUploader">
                                <img id="logoImg" class="avatar avatar-md avatar-4x3 avatar-centered h-100 mb-2" src="../assets/svg/illustrations/oc-browse.svg" alt="Image Description">
                                <span class="d-block">Browse your file here</span>
                                <input name="foto" type="file" class="form-check-input" id="logoUploader"  value="{{ old('foto') }}">
                            </label>
                        </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img1.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img1-dark.jpg" alt="Image Description"
        ...
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img12.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img12-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img11.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img11-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img3.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img3-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-body">
                    ...
                    <p class="card-text lead">Present web app in full content with a single collapsible navigation bar.
                    </p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img2.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img2-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6 mb-4 mb-md-0">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img13.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img13-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img5.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img5-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
...
<div class="container-lg">
    <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
            <div class="mb-4">
                <img class="img-fluid mx-auto" src="assets/svg/illustrations/oc-review.svg" alt="Image Description"
                    data-hs-theme-appearance="default" style="max-width: 10rem;">
                <img class="img-fluid mx-auto" src="assets/svg/illustrations-light/oc-review.svg"
            ...
            <p class="fs-2 text-dark mb-4"><em>This is a perfect theme for a modern web application. <span
                        ...
                        designing</span> all of the components to look coherent and work well together in various grid
                    layouts.</em></p>
    ...
    <div class="row">
        <div class="col-md-7 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="assets/img/others/img4.png" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid" src="assets/img/others/img4-dark.png" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-5 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="assets/img/others/img3.png" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid" src="assets/img/others/img3-dark.png" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-5 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="assets/img/others/img6.png" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid" src="assets/img/others/img6-dark.png" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-7 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="assets/img/others/img5.png" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid" src="assets/img/others/img5-dark.png" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Upload images, videos or any files, copy to clipboard, toggle passwords,
                        search, add fields, count characters and discover more customizable and feature-rich plugins.
                    </p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="assets/img/others/img8.png" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid" src="assets/img/others/img8-dark.png" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-5">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="assets/img/others/img7.png" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid" src="assets/img/others/img7-dark.png" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
...
<div class="content-space-b-2">
    ...
    <div class="sliding-img mb-5">
        <div class="sliding-img-frame-to-start" style="background-image: url(assets/img/others/img1.png);"
            data-hs-theme-appearance="default"></div>
        <div class="sliding-img-frame-to-start" style="background-image: url(assets/img/others/img1-dark.png);"
            data-hs-theme-appearance="dark"></div>
    </div>

    <div class="sliding-img">
        <div class="sliding-img-frame-to-end" style="background-image: url(assets/img/others/img2.png);"
            data-hs-theme-appearance="default"></div>
        <div class="sliding-img-frame-to-end" style="background-image: url(assets/img/others/img2-dark.png);"
            data-hs-theme-appearance="dark"></div>
    </div>
</div>
<!-- End Sliding Image -->
    ...
    <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
            ...
            <p class="fs-2 text-dark mb-4"><em>The theme has a very professional look, bringing a more modern and clean
                    style to the application. <span class="text-highlight-warning">The documentation is extraordinarily
                        rich and complete</span>, helping implementation.</em></p>
        ...
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img7.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img7-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
    ...
    <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img8.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img8-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
    ...
    <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img9.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img9-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
        ...
        <div class="col-md-6">
            <div class="pe-md-7">
                ...
                <a class="btn btn-primary" target="_blank" href="apps-invoice-generator.html">Preview Invoice Generator
    ...
    <div class="row align-items-md-center content-space-t-1">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img10.jpg" alt="Image Description"
                        data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="assets/img/900x562/img10-dark.jpg" alt="Image Description"
                        data-hs-theme-appearance="dark">
                </div>
...
<div class="container-lg">
    <div class="bg-dark position-relative rounded overflow-hidden pt-4 px-4 pt-sm-10 px-sm-10">
        ...
        <img class="img-fluid" src="assets/svg/illustrations/docs-main-page.svg" alt="Image Description"
            data-hs-theme-appearance="default">
        <img class="img-fluid" src="assets/svg/illustrations/docs-main-page-dark.svg" alt="Image Description"
            data-hs-theme-appearance="dark">
    ...
    <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
            ...
            <p class="fs-2 text-dark mb-4"><em>This theme is really great, as back end developer <span
                        class="text-highlight-warning">I was able to build an impressive front end using this theme in
                        plain JavaScript vanilla. The source code is clear and the documentation as well, for me it's
                        the best purchase I made with this team and I am watching evolution.</span> Thank you so much
                    for such quality and price. Keep going!</em></p>
        ...
        <div class="w-md-75 mx-md-auto">
            <div class="position-relative">
                ...
                <div class="d-none d-md-block position-absolute bottom-0 start-0">
                    <img class="img-fluid" src="assets/svg/illustrations/oc-peeking.svg" alt="Image Description"
                        data-hs-theme-appearance="default" style="max-width: 8rem; margin-left: -7.8125rem;">
                    <img class="img-fluid" src="assets/svg/illustrations-light/oc-peeking.svg" alt="Image Description"
                        data-hs-theme-appearance="dark" style="max-width: 8rem; margin-left: -7.8125rem;">
                </div>

                <div class="d-none d-md-block position-absolute top-50 end-0 translate-middle-y">
                    <img class="img-fluid" src="assets/svg/illustrations/oc-on-the-go.svg" alt="Image Description"
                        data-hs-theme-appearance="default" style="max-width: 15rem; margin-right: -15rem;">
                    <img class="img-fluid" src="assets/svg/illustrations-light/oc-on-the-go.svg" alt="Image Description"
                        data-hs-theme-appearance="dark" style="max-width: 15rem; margin-right: -15rem;">
                </div>
            </div>
        </div>
    </div>
        ...
        <ul class="list-unstyled list-py-3 mb-0">
            <li>
                ...
                <p class="fs-4">If you'd like a refund please reach out to us at <a class="link"
                        href="mailto:themes@getbootstrap.com">themes@getbootstrap.com</a>. If you need technical help
                    with the theme before a refund please reach out to us first.</p>
            </li>
            ...
            <li>
                ...
                <p class="fs-4">If you lose the link for a theme you purchased, don't panic! We've got you covered. You
                    ...
                    didn't create a <a class="link" href="https://marketplace.getbootstrap.com/signin/"
                        target="_blank">login</a> or can't remember the information, you can use our handy <a
                        class="link" href="https://themes.getbootstrap.com/redownload/" target="_blank">Redownload
                        page</a>, just remember to use the same email you originally made your purchases with.</p>
            </li>
