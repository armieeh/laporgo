<header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-soft-primary">
  <div class="navbar-nav-wrap">
    ...
    <div class="navbar-nav-wrap-content-start">
      <h1 class="mt-2">Selamat Datang {{ Auth::guard('admin')->user()->nama}}</h1>
          ...
          <div class="dropdown">
            <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside" data-bs-dropdown-animation>
              <div class="avatar avatar-sm avatar-circle">
                <img class="bg-soft-secondary avatar-img" src="/assets/img/admin.png" alt="Image Description">
